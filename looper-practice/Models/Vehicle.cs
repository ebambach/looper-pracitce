...
namespace looper_practice.Models
{
    public class Vehicle
    {
        ...
        public string[] films { get; set; } // An array of Film URL Resources that this vehicle has appeared in.
        public string[] pilots { get; set; } // An array of People URL Resources that this vehicle has been piloted by.
